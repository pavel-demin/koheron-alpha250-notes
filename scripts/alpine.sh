...
zip -r koheron-alpha250-alpine-3.18-armv7-`date +%Y%m%d`.zip apps boot.bin cache koheron-alpha250.apkovl.tar.gz modloop wifi

rm -rf apps cache koheron-alpha250.apkovl.tar.gz modloop wifi
