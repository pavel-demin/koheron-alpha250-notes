...
zip -r koheron-alpha250-alpine-3.14-armv7-`date +%Y%m%d`.zip apps boot.bin cache devicetree.dtb koheron-alpha250.apkovl.tar.gz modloop uEnv.txt uImage uInitrd wifi
